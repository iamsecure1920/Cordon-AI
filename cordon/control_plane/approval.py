...
from cordon.errors import ApprovalDenied, ApprovalRequired
...
log = logging.getLogger("cordon.approval")
...
class ApprovalRequest:
    ...
    def prompt(self) -> str:
        lines = [
            f"Cordon is requesting approval to run an {self.mode.upper()} action.",
            "",
            f"  tool    : {self.tool}",
            f"  phase   : {self.phase}",
