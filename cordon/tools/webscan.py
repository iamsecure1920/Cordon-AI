...
disk, invisible to ``cordon doctor``, unreachable from the agent, and — in the
...
:mod:`cordon.tools.http_probe` and is not duplicated here.
"""
...
from cordon.tools.common import (
    HOST_PATTERN,
    PATH_PATTERN,
    URL_PATTERN,
    ToolRun,
...
TESTSSL = register_spec(
    ToolSpec(
        ...
        arg_policy=ArgPolicy(
            ...
            # The engagement user-agent is "Cordon-AI/2.0 (authorized-testing)":
...
async def websocket_probe(target: str, origin: str | None = None) -> dict[str, Any]:
    ...
    foreign_origin = origin or "https://cordon-cswsh-check.example"
...
async def fuzz_compare(
    ...
    from cordon.tools.fuzz_diff import Case, diff_case, group_cases, label_clusters
