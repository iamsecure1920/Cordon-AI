...
Distinct from everything else in Cordon: here the model under test belongs to
...
from cordon.tools.common import register_spec, run_one, split_targets
...
# Probe families Cordon will run, mapped to what a finding from each is worth.
...
async def llm_probe_catalog() -> dict[str, Any]:
    ...
    """
    from cordon.tools.common import installed
