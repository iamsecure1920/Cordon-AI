...
from cordon.tools.base import ToolSpec, cordon_tool, register_container_mount
...
def _framework_root() -> Path | None:
    configured = os.environ.get("CORDON_SMUGGLER_FRAMEWORK")
    ...
    if root is None:
        return {
            ...
            "message": (
                ...
                "CORDON_SMUGGLER_FRAMEWORK to its directory, or place it at "
