...
``research_guidance`` assembles everything Cordon already knows into one
actionable answer:

* the **brain's learned experience** for this class on this shape of target
  (what actually paid off before, from :mod:`cordon.knowledge.neuron`),
...
answer (Cordon's own strategy layer is a model and reads it directly).
