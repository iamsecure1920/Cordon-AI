...
A different domain from the rest of Cordon, sharing the same control plane.
...
#: Slither impact -> Cordon severity. Slither's own "High" means high *impact*
...
async def contract_toolchain() -> dict[str, Any]:
    ...
    """
    from cordon.tools.common import installed, verify_identity
