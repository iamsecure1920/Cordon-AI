---
name: cordon-takeover
description: >
  Detect and verify subdomain takeovers with Cordon's three-step flow, then
...
```
cordon doctor | grep subdomainsleuth
```
...
Cordon does not claim resources for you. `takeover_poc_plan(host)` returns:
