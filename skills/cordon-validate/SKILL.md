---
name: cordon-validate
description: >
  Prove candidate findings with minimal proof-of-concept validation in Cordon,
...
- Never test availability. Nothing in Cordon does load or DoS testing, and
