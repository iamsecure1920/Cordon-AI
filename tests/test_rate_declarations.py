...
_SENDS_NOTHING: dict[str, str] = {
    ...
    "engagement_attach": "re-opens a workspace from disk; the only reads are local",
    "engagement_new": "creates/re-opens the engagement workspace; local disk only",
    ...
    "pipeline_status": "reads pipeline-state.json and status.jsonl off local disk",
    "recon_review": "ranks live hosts from the asset store; zero network traffic",
