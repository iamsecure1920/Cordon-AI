...
2.7 GB ``easyhunt:latest`` this repo builds — that carries ~40 binaries at once;
...
log = logging.getLogger("easyhunt.sandbox")
...
SHARED_IMAGE_ENV = {"EASYHUNT_QUIET": "1"}
...
class Sandbox:
    ...
    def is_shared_image(self, image: str | None) -> bool:
        ...
        treated as shared too, so ``images: {sqlmap: easyhunt:latest}`` behaves
