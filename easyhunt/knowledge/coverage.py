...
COVERAGE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "detection": "technique + parameter review", "validation": "none — no validator binary",
        "payloads": ["xml.txt"], "gf": [], "status": "detect-only",
        "bypass": "xxe-injection",
        "note": "xml.txt is vetted tier B but unconsumed; a validator must be built or a human confirms.",
    },
    {
        "class": "crlf-injection", "title": "CRLF Injection", "phase": "input_validation",
        "detection": "technique + parameter review", "validation": "none",
        "payloads": ["crlf.txt"], "gf": [], "status": "detect-only",
        "bypass": "crlf-injection",
        "note": "crlf.txt is vetted tier B but unconsumed.",
    },
    {
        "class": "file-inclusion", "title": "LFI / Path Traversal", "phase": "input_validation",
        "detection": "gf:lfi + ffuf (traversal-unix/win)", "validation": "none — discovery only",
        "payloads": ["directory_traversal_unix.txt", "directory_traversal_win.txt", "lfi.txt"], "gf": ["lfi"], "status": "detect-only",
        "bypass": "file-inclusion",
        "note": "ffuf finds readable paths; confirming file read/inclusion is a human step today.",
    },
    {
        "class": "open-redirect", "title": "Open Redirect", "phase": "input_validation",
        "detection": "gf:redirect + pattern_scan", "validation": "none — no active confirmation",
        "payloads": [], "gf": ["redirect"], "status": "detect-only",
