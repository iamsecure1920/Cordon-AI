...
CAPABILITY_MODULES = [
    ...
    "easyhunt.tools.web_injection",
    "easyhunt.tools.exploit_chain",
    "easyhunt.tools.webscan",
    "easyhunt.tools.waf_bypass",
    "easyhunt.tools.prompts",
    "easyhunt.tools.burp",
    "easyhunt.tools.code_audit",
    "easyhunt.tools.hunt_plan",
    "easyhunt.tools.auth_crawl",
