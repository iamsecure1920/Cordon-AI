...
from easyhunt.engines.semgrep_engine import SPEC as SEMGREP_SPEC
from easyhunt.engines.semgrep_engine import parse_semgrep_output
from easyhunt.knowledge.findings import Evidence, Finding, Severity, Status
from easyhunt.tools.base import easyhunt_tool, guarded_run
from easyhunt.tools.secrets import GITLEAKS

log = logging.getLogger("easyhunt.tools.code_audit")
...
async def _run_semgrep(engagement: Any, scan_path: Path) -> list[dict[str, Any]]:
    ...
    from easyhunt.engines.semgrep_engine import _configs
