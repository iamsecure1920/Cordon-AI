...
log = logging.getLogger("easyhunt.llm")
...
class LLMClient:
    ...
    def __init__(self, engagement: Any) -> None:
        ...
        self.title = str(config.get("llm.title", "EasyHunt AI"))
    ...
    async def probe(self) -> dict[str, Any]:
        ...
        Model names get renamed and retired. ``easyhunt doctor`` runs this so a
